<form action="{{request()->segment(2) == 'product' ? 'shop' : ''}}">
    ...
    <div class="filter-widget">
        ...
        <div class="fw-color-choose">
            <div class="cs-item">
                <input type="radio" id="cs-back" name="color" value="black" onchange="this.form.submit();"
                    {{request('color') == 'black' ? 'checked': '' }}>
                <label class="cs-black {{request('color') == 'black' ? 'font-weight-bold': '' }}" for="cs-back">Black</label>
            </div>
            <div class="cs-item">
            ...
            <div class="cs-item">
                <input type="radio" id="cs-red" name="color" value="ref" onchange="this.form.submit();"
            ...
            <div class="cs-item" name="color" value="" onchange="this.form.submit()">
